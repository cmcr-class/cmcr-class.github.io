...
\begin{tabular}{p{.75in} p{4.25in}}
	...
	\recommended{ \begin{enumerate}
    	...
    	\item \href{http://rmarkdown.rstudio.com/articles_docx.html}{Layton, Richard. 2015. ``Happy Collaboration with Rmd to docx.''}
	\end{enumerate}}\\
	\\
\end{tabular}
...
\begin{tabular}{p{.75in} p{4.25in}}
    ...
    % https://github.com/jennybc/ggplot2-tutorial
        \assignment{\href{http://r4ds.had.co.nz}{Grolemund, Garrett, and Hadley Wickham.  2016.  \textit{R for Data Science.}} Introductory chapters ``Welcome'' and ``Introduction,'' plus the section ``Explore'' (currently chapters 2-8, but the book is still in progress, so that might change).}\\
        \\
        \recommended{\begin{enumerate}
    	\item \href{http://www.cookbook-r.com/Graphs/}{Chang, Winston. \emph{Cookbook for R}.  Chapter 8: Graphs.}  I~refer to this all the time.
    ...
    Sept 21 &	Wranglin' Data \\
		\assignment{\href{http://r4ds.had.co.nz}{Grolemund, Garrett, and Hadley Wickham.  2016.  \textit{R for Data Science.}} Section ``Wrangle'' (currently chapters 9-16).}\\
	    \\
  	...
  	\\	  
    Sept 28 &   Programming	  \\
    	\assignment{\href{http://r4ds.had.co.nz}{Grolemund, Garrett, and Hadley Wickham.  2016.  \textit{R for Data Science.}} Section ``Program'' (currently chapters 17-21).}\\
    \\      
\end{tabular} 
\begin{tabular}{p{.75in} p{4.25in}}
    Oct 5 &     Scraping (and Managing) Data \\
...
@
        \item \href{http://r4ds.had.co.nz}{Grolemund, Garrett, and Hadley Wickham.  2016.  \textit{R for Data Science.}} Section ``Communicate'' (currently chapters 26-30).
	    \end{enumerate}
	    }	\\
    Oct 12 &	Exam  \\
    \\     
